...
data = dict(
    ...
    train=dict(
        ...
        classes=['front_face', 'inverse_face'],
...
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/detector_2class_real_test/3_repvgg_0.25_repvggnet_1113_1311_nopad_AdamW_0.005_keypoint_weight_11_test'
